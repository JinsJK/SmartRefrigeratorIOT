# 1 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
...
# 6 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 7 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 8 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/home/jins/bl_iot_sdk/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 10 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
# 11 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 2
...
int inode_alloc()
{
    ...
    return -
# 32 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
           12
# 32 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                 ;
}
...
int inode_del(inode_t *node)
{
    if (node->refs > 0) {
        return -
# 38 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               16
# 38 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                    ;
    }

    if (node->refs == 0) {
        if (node->i_name != 
# 42 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 42 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            vPortFree(node->i_name);
        }

        node->i_name = 
# 46 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                      ((void *)0)
# 46 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                          ;
        node->i_arg = 
# 47 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                     ((void *)0)
# 47 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                         ;
        node->i_flags = 0;
...
inode_t *inode_open(const char *path)
{
    ...
    for (e = 0; e < 30; e++) {
        ...
        if (node->i_name == 
# 63 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 63 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        }
    ...
    return 
# 77 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
          ((void *)0)
# 77 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
              ;
}
...
int inode_forearch_name(int (*cb)(void *arg, inode_t *node), void *arg)
{
    ...
    for (e = 0; e < 30; e++) {
        node = &g_vfs_dev_nodes[e];
        if (node->i_name == 
# 87 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 87 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                               ) {
            continue;
        } else {
            count++;
...
int inode_ptr_get(int fd, inode_t **node)
{
    if (fd < 0 || fd >= 30) {
        return -
# 103 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               22
# 103 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
static int inode_set_name(const char *path, inode_t **inode)
{
    ...
    if (!mem) {
        return -
# 150 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               12
# 150 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_reserve(const char *path, inode_t **inode)
{
    int ret;
    inode_t *node = 
# 163 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
                   ((void *)0)
# 163 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                       ;

    do { if (!(path != 
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   && inode != 
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
   22
# 165 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    *inode = 
# 166 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
            ((void *)0)
# 166 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                ;
    ...
    if (path[0] == '\0' || path[0] != '/') {
        ...
        return -
# 174 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               22
# 174 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_release(const char *path)
{
    ...
    do { if (!(path != 
# 198 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 198 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 198 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
   22
# 198 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    ...
    if (node == 
# 201 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3 4
               ((void *)0)
# 201 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                   ) {
        return -
# 202 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c" 3
               19
# 202 "/home/jins/bl_iot_sdk/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
