# 1 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
# 1 "/home/jins/bl_iot_sdk/customer_app/tt_app_temperature/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
# 30 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
...
# 31 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 32 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 34 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 37 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
# 38 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
# 1 "/home/jins/bl_iot_sdk/components/bl602/freertos_riscv_ram/panic/panic.h" 1



int backtrace_now(int (*print_func)(const char *fmt, ...), uintptr_t *regs);
int backtrace_now_app(int (*print_func)(const char *fmt, ...));
# 39 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 2
...
void bl_irq_register_with_ctx(int irqnum, void *handler, void *ctx)
{
    ...
    if (handler == 
# 129 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                  ((void *)0)
# 129 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                      ) {
        ;
        return;
    }
    ...
    if (
# 134 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
       ((void *)0) 
# 134 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
            == ctx) {
        handler_list[0][irqnum] = handler;
        handler_list[1][irqnum] = 
# 136 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                                 ((void *)0)
# 136 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                                     ;
    }
    else {
        handler_list[0][irqnum] = handler;
...
# 157 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                                             ((void *)0)
# 157 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                                                 );
}
...
{
    void *handler = 
# 175 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c" 3 4
                   ((void *)0)
# 175 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
                       ;
    mcause &= 0x7FFFFFF;
...
# 316 "/home/jins/bl_iot_sdk/components/hal_drv/bl602_hal/bl_irq.c"
